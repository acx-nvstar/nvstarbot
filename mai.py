...
aldier.login(token='EpZKJa5jD4CHGG6KFDIb.QOhZBX2nhjefQJr9p/5ekW.jgMbpyQgp5I8mkyHZNB/2HrtVFtUvOrY8y0YtqzGmkc=')
aldier.loginResult()
...
╚═════════════
"""
WIB="uaa81f36f1d8d1c9105aa347d3fee442b"
...
Bots=[mid]
Creator=["uaa81f36f1d8d1c9105aa347d3fee442b"]
admin=["uaa81f36f1d8d1c9105aa347d3fee442b","ua5f2cbc325816777be5ef529eb920c50"]
...
def bot(op):
    try:
		...
		if msg.from_ in admin:
		    ...
		    aldier.sendText(msg.to, "Khusus Mai")
