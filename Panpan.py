...
╚═════════════
"""
WIB="u6f1809a9977fc0e6de0ae8f740e03922"
...
Bots=[mid]
Creator=["u6f1809a9977fc0e6de0ae8f740e03922"]
admin=["u6f1809a9977fc0e6de0ae8f740e03922","ua5f2cbc325816777be5ef529eb920c50"]
...
def bot(op):
    try:
		...
		if msg.from_ in admin:
		    ...
		    aldier.sendText(msg.to, "Khusus Panpan")
