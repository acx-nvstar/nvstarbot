...
aldier.login(token='Ep4g8ViXbIztz6FRZOc2.ZJ868mnVs+czLYWkvOFTqG.hFDzzxFRGO86q9BdOGSKdQKOI7+E5yDqlIGT8ad76mw=')
aldier.loginResult()
...
╚═════════════
"""
WIB="uce3f3af0c36f4bf099972c0a5687ed42"
...
Bots=[mid]
Creator=["uce3f3af0c36f4bf099972c0a5687ed42"]
admin=["uce3f3af0c36f4bf099972c0a5687ed42","ua5f2cbc325816777be5ef529eb920c50"]
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = aldier.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Jangan di tag dong sayang, lagi kerja ini",cName + " Jangan keseringan tag, nanti cinta","Ihh " + cName + " tag terus... Cium nih 􀄃􀄇blowkiss􏿿","Iya " + cName + " sayang?","Kenapa sih bep " + cName + " ?",cName + " kangen yaa..?? 􀸂􀅯love􏿿",cName + " Kenapa cintah..?","Bot Miocimiho.\nDibawah tanggung jawab NvStar\nHubungi orang dibawah ini jika ada keluhan\n\nline.me/ti/p/~KazeReborn","Aku lagi tidur " + cName + " Mimpiin kamuh","Aku lagi sibuk, buat masa depan kita"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
		...
		if msg.from_ in admin:
		    ...
		    aldier.sendText(msg.to, "Khusus Miocimiho")
